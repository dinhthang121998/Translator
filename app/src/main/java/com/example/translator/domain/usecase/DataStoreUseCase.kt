...
class DataStoreUseCase @Inject constructor(private val protoPreferenceManager: ProtoPreferenceManager) {
    ...
    suspend fun storeSwapLanguageItem(fromLanguageItem: SearchLanguageItem.LanguageItem, toLanguageItem: SearchLanguageItem.LanguageItem) {
